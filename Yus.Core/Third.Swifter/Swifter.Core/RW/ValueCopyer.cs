...
namespace Swifter.RW
{
    ...
    public sealed class ValueCopyer : IValueRW
    {
        ...
        public bool IsEmptyValue()
        {
            ...
            {
                case ValueTypeCodes.Boolean:
                    return value.Boolean == default(bool);
                case ValueTypeCodes.SByte:
                    return value.SByte == default(sbyte);
                case ValueTypeCodes.Int16:
                    return value.Int16 == default(short);
                case ValueTypeCodes.Int32:
                    return value.Int32 == default(int);
                case ValueTypeCodes.Int64:
                    return value.Int64 == default(long);
                case ValueTypeCodes.Byte:
                    return value.Byte == default(byte);
                case ValueTypeCodes.UInt16:
                    return value.UInt16 == default(ushort);
                case ValueTypeCodes.UInt32:
                    return value.UInt32 == default(uint);
                case ValueTypeCodes.UInt64:
                    return value.UInt64 == default(ulong);
                case ValueTypeCodes.Single:
                    return value.Single == default(float);
                case ValueTypeCodes.Double:
                    return value.Double == default(double);
                case ValueTypeCodes.Decimal:
                    return value.Decimal == default(decimal);
                case ValueTypeCodes.Char:
                    return value.Char == default(char);
                case ValueTypeCodes.DateTime:
                    return value.DateTime == default(DateTime);
                case ValueTypeCodes.String:
