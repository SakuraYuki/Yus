...
namespace System
{
    ...
    public static class DictionaryExtension
    {
        ...
        /// <returns>指定键的值或者默认值</returns>
        public static T YusDictValue<T>(this Dictionary<string, object> dict, string key, T defaultValue = default)
        {
        ...
        /// <returns>指定键的值或者默认值</returns>
        public static T YusDictObject<T>(this Dictionary<string, object> dict, string key, T defaultValue = default)
        {
