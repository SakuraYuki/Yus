...
#pragma warning disable CS0618 // 类型或成员已过时
        ...
        /// <returns></returns>
        public static long DateTimeToUnix(DateTime date = default)
        {
            var startTime = TimeZone.CurrentTimeZone.ToLocalTime(OriginDate); // 当地时区
        ...
        /// <param name="date">要转换的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static long DateTimeToJs(DateTime date = default)
        {
            var startTime = TimeZone.CurrentTimeZone.ToLocalTime(OriginDate); // 当地时区
        ...
        /// <returns></returns>
        public static string StringDate(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringTime(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateCN(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringTimeCN(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateTime(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateTimeCN(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringLongTime(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringLongTimeCN(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateUnderline(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringTimeUnderline(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateTimeUnderline(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringLongTimeUnderline(DateTime date = default)
        {
        ...
        /// <param name="date">要格式化的时间，不传入则为当前时间</param>
        /// <returns></returns>
        public static string StringDateSlash(DateTime date = default)
        {
