...
namespace Swifter.Reflection
{
    sealed class XStructPropertyInfo<TStruct, TValue> : XPropertyInfo, IXFieldRW where TStruct : struct
    {
        ...
        public T ReadValue<T>(object obj)
        {
            ...
            if (_get is XStructGetValueHandler<TStruct, T>)
            {
                var __get = _get as XStructGetValueHandler<TStruct, T>;
        ...
        public void WriteValue<T>(object obj, T value)
        {
            ...
            if (_set is XStructSetValueHandler<TStruct, T>)
            {
                var __set = _set as XStructSetValueHandler<TStruct, T>;
